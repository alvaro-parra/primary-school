...
const STRINGS = {
  es: {
    ...
    pn_add: "Sumar",
    pn_subtract: "Restar",
    // Lecciones de aritmética entera
    lesson_add: "Sumas",
    lesson_subtract: "Restas",
    lesson_multiply: "Multiplicaciones",
    lesson_divide: "Divisiones",
    add_sub: "Suma números",
    sub_sub: "Resta números",
    mul_sub: "Multiplica números",
    div_sub: "Reparte en partes iguales",
    addNum: "¿Cuánto suma?",
    subNum: "¿Cuánto queda?",
    mulNum: "¿Cuánto es?",
    divNum: "¿Cuánto toca a cada uno?",
    pn_addBasic: "Suma fácil",
    pn_addCarry: "Suma con llevadas",
    pn_subBasic: "Resta fácil",
    pn_subBorrow: "Resta con préstamo",
    pn_mulSmall: "Multiplica fácil",
    pn_mulTen: "Multiplica por 10",
    pn_divSmall: "Divide fácil",
    pn_divTen: "Divide entre 10",
    // Tablas de consulta y práctica libre
    tables: "Tablas",
    table_add: "Tabla de sumar",
    table_mul: "Tabla de multiplicar",
    try_it: "Pruébalo tú",
    // Medidas
    lesson_measures: "Medidas",
    measures_sub: "Longitud, capacidad, masa y tiempo",
    lesson_length: "Longitud",
    lesson_mass: "Masa",
    lesson_capacity: "Capacidad",
    lesson_time: "Tiempo",
    length_sub: "Mide lo largo (cm, mm)",
    mass_sub: "Mide el peso (kg, g)",
    capacity_sub: "Mide el líquido (L, dL, mL)",
    time_sub: "Mide cuánto dura (d, h, min, s)",
    units_btn: "Unidades",
    pick_units: "Elige las unidades",
    unit_table: "Tabla de unidades",
    ladder_rule: "La escalera",
    other_units: "En otras unidades",
    converter: "Conversor",
    done: "Listo",
    mConvertQ: "Completa la conversión",
    mCompareQ: "¿Cuál es mayor?",
    mAddQ: "Suma las medidas",
    mSubQ: "Resta las medidas",
    // Nombres de los problemas de medida (iguales en los tres sistemas)
    mn_down: "Convertir a la unidad menor",
    mn_mixed: "Separar en dos unidades",
    mn_compose: "Juntar en una unidad",
    mn_compare: "¿Cuál es mayor?",
    mn_add: "Sumar medidas",
    mn_sub: "Restar medidas",
  },
  ja: {
    appName: "ミドク",
    tagline: "はかって まなぼう",
    ...
    sub_sub: "すうじを ひこう",
    mul_sub: "すうじを かけよう",
    div_sub: "おなじ かずに わけよう",
    addNum: "こたえは いくつ？",
    subNum: "こたえは いくつ？",
    mulNum: "こたえは いくつ？",
    divNum: "ひとつぶん は いくつ？",
    pn_addBasic: "やさしい たしざん",
    pn_addCarry: "くりあがり たしざん",
    pn_subBasic: "やさしい ひきざん",
    pn_subBorrow: "くりさがり ひきざん",
    pn_mulSmall: "やさしい かけざん",
    pn_mulTen: "10を かける",
    pn_divSmall: "やさしい わりざん",
    pn_divTen: "10で わる",
    // 表と じゆうれんしゅう
    tables: "ひょう",
    table_add: "たしざんの ひょう",
    ...
    // たんい
    lesson_measures: "たんい",
    measures_sub: "ながさ・かさ・おもさ・じかん",
    lesson_length: "ながさ",
    lesson_mass: "おもさ",
    lesson_capacity: "かさ",
    lesson_time: "じかん",
    length_sub: "ながさ（cm・mm）",
    mass_sub: "おもさ（kg・g）",
    capacity_sub: "かさ（L・dL・mL）",
    time_sub: "じかん（d・h・min・s）",
    units_btn: "たんい",
    pick_units: "たんいを えらぶ",
    unit_table: "たんいの ひょう",
    ladder_rule: "たんいの かいだん",
    other_units: "ほかの たんいで",
    converter: "へんかん",
    done: "できた",
    mConvertQ: "たんいを なおそう",
    mCompareQ: "どちらが おおきい？",
    mAddQ: "たして みよう",
    mSubQ: "ひいて みよう",
    // 問題の なまえ（3つの たんいで おなじ）
    mn_down: "ちいさい たんいに なおす",
    mn_mixed: "2つの たんいに わける",
    mn_compose: "1つの たんいに まとめる",
    mn_compare: "どちらが おおきい？",
    mn_add: "たんいの たしざん",
    mn_sub: "たんいの ひきざん",
  },
};
